...
export default function Home() {
  ...
  </main><footer className="footer"><div className="container"><div className="footer-row"><div><a className="brand" href="#top"><span className="brand-mark">GB</span>Galgotias Bunk</a><div className="footer-tagline">Know your attendance. Plan your bunks.</div></div><div className="footer-links"><a href="#features">Features</a><a href="#how-it-works">How It Works</a><a href="#">Privacy</a><a href="mailto:hello@galgotiasbunk.com">Contact</a></div></div><div className="footer-bottom"><span>© 2024 Galgotias Bunk</span></div></div></footer></div>;
}
